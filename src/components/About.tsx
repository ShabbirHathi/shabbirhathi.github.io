                ...
                <CardContent className="p-0">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">NLP, embeddings, RAG systems, and intelligent agents</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Python, Django, Flask, and scalable system design</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">End-to-end solutions from MVP to deployment</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
